        ...
        <form className="form-projeto" onSubmit={handleSubmit}>
          <div className="container">
            ...
            <div className="row row-border g-3 areaconj">
              <div className="col-md-12 title-proj">
                {" "}
                Áreas Temáticas (máx. 3){" "}
              </div>

              <div className="d-flex justify-content-center flex-wrap gap-4">
                <div className="col-md-5 d-flex flex-column align-items-end">
                  <div className="form-check d-flex align-items-center">
                    <label className="form-check-label me-2" htmlFor="check1">
                      Comunicação
                    </label>
                    <input
                  ...
                  <div className="form-check d-flex align-items-center">
                    <label className="form-check-label me-2" htmlFor="check2">
                      Meio Ambiente
                    </label>
                    <input
                      className="form-check-input custom-checkbox"
                  ...
                  <div className="form-check d-flex align-items-center">
                    <label className="form-check-label me-2" htmlFor="check3">
                      Cultura
                    </label>
                    <input
                      className="form-check-input custom-checkbox"
                  ...
                  <div className="form-check d-flex align-items-center mb-3">
                    <label className="form-check-label me-2" htmlFor="check4">
                      Saúde
                    </label>
                    <input
                      className="form-check-input custom-checkbox"
                ...
                <div className="col-md-5 d-flex flex-column align-items-end">
                  <div className="form-check d-flex align-items-center">
                    <label className="form-check-label me-2" htmlFor="check5">
                      Direitos Humanos
                    </label>
                    <input
                      className="form-check-input custom-checkbox"
                  ...
                  <div className="form-check d-flex align-items-center">
                    <label className="form-check-label me-2" htmlFor="check6">
                  ...
                  <div className="form-check d-flex align-items-center">
                    <label className="form-check-label me-2" htmlFor="check7">
                      Educação
                    </label>
                    <input
                      className="form-check-input custom-checkbox"
                  ...
                  <div className="form-check d-flex align-items-center mb-3">
                    <label className="form-check-label me-2" htmlFor="check8">
                      Trabalho
                    </label>
                    <input
                      className="form-check-input custom-checkbox"
            ...
            <div className="row row-border d-flex justify-content-center g-3">
              <div className="col-md-12 title-add mb-4 title-proj">
                {" "}
                Cadastro em Evento{" "}
              </div>
